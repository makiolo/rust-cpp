...
def window(data, period=20):
    return _red_pandas.window(data, period)
...
def range(elements):
    return _red_pandas.range(elements)

def rangeref(elements):
    return _red_pandas.rangeref(elements)
